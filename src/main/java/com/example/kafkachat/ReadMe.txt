...
Group 1: MODERATEUR, SOURCING, COMMERCE, ADV

Group 2: CLIENT, CANDIDAT, AMBASSADEUR, SOURCING_COMMERCE, AUTRE

Special Role: ADMIN

🔐 Chat Permission Rules
The method canChat(String roleA, String sroleB) defines the logic:
